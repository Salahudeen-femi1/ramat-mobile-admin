...
import { getOrderById, updateOrderTrack } from "../service/apiService";
...
export default function Tracking() {
  ...
  const statusMutation = useMutation({
    mutationFn: ({
      ...
      orderId: string;
      status: OrderStatus;
    }) => updateOrderTrack(orderId, status),
              ...
              <div className="space-y-2">
                {(
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-lg text-sm capitalize ${
                      order.status === status
